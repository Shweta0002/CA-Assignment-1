#include "ooo_cpu.h"
/*#define TAGE_BIMODAL_TABLE_SIZE 146400
...
const uint8_t TAGE_INDEX_BITS[TAGE_NUM_COMPONENTS] = {14, 13, 14, 13};
const uint8_t TAGE_TAG_BITS[TAGE_NUM_COMPONENTS] = {12, 13, 14, 15}; 
tage1,2,3 txt
...
#define TAGE_BIMODAL_TABLE_SIZE 97248
#define TAGE_MAX_INDEX_BITS 14
#define TAGE_NUM_COMPONENTS 4 // TODO
#define TAGE_BASE_COUNTER_BITS 2
#define TAGE_COUNTER_BITS 3
...
const uint8_t TAGE_INDEX_BITS[TAGE_NUM_COMPONENTS] = {14, 14, 14, 14};
const uint8_t TAGE_TAG_BITS[TAGE_NUM_COMPONENTS] = {8,9,10,11};
...
#define Path uint64_t
#define History uint64_t
#define TAGE_BIMODAL_TABLE_SIZE 138208
#define TAGE_MAX_INDEX_BITS 13
#define TAGE_NUM_COMPONENTS 4 // TODO
#define TAGE_BASE_COUNTER_BITS 2
#define TAGE_COUNTER_BITS 3
#define TAGE_USEFUL_BITS 2
...
#define TAGE_PATH_HISTORY_BUFFER_LENGTH 32
#define TAGE_MIN_HISTORY_LENGTH 4
#define TAGE_HISTORY_ALPHA 3
#define TAGE_RESET_USEFUL_INTERVAL 512000

const uint8_t TAGE_INDEX_BITS[TAGE_NUM_COMPONENTS] = {12, 13, 12, 13};
const uint8_t TAGE_TAG_BITS[TAGE_NUM_COMPONENTS] = {9, 10, 11, 12};
